...
const ProductUpdate = () => {
  ...
  const [productState, setProductState] = useState(productData?.state || "");
  const [story, setStory] = useState(productData?.story || "");
  const [craftProcess, setCraftProcess] = useState(productData?.craftProcess || "");
  const [artisanInfo, setArtisanInfo] = useState(productData?.artisanInfo || "");
  ...
  useEffect(() => {
    if (productData && productData._id) {
      ...
      setStory(productData.story || "");
      setCraftProcess(productData.craftProcess || "");
      setArtisanInfo(productData.artisanInfo || "");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("craftProcess", craftProcess);
      formData.append("artisanInfo", artisanInfo);
          ...
          <div className="flex flex-col ">
            ...
            <div className="p-3">
              ...
              <div className="flex flex-col gap-1 mt-4">
                ...
                <textarea
                  type="text"
                  className="mt-1 p-2 border rounded  mb-4 bg-[#0E1629] placeholder-[#eaeaeab9]  text-[#F6F6F6] outline-none border-[#57575b] focus:border-[#FF2E63] w-[320px] md:w-[460px] xl:w-[100%]"
                  value={story}
