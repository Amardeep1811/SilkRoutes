...
const addProduct = asyncHandler(async (req, res) => {
  try {
    const { name, description, price, category, quantity, state } = req.fields;
    ...
    switch (true) {
      ...
      case !state:
        return res.json({ error: "State is required" });
      case !description:
...
const filterProducts = asyncHandler(async (req, res) => {
  try {
    const { checked, radio, state, keyword } = req.body;
